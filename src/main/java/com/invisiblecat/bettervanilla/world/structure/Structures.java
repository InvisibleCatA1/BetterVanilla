package com.invisiblecat.bettervanilla.world.structure;
...
public class Structures {
     ...
     */
    public static final DeferredRegister<StructureFeature<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, BetterVanilla.MODID);
     ...
     */
    public static final RegistryObject<StructureFeature<JigsawConfiguration>> SMALL_RUINS = DEFERRED_REGISTRY_STRUCTURE.register("small_ruins", () -> (new SmallRuins(JigsawConfiguration.CODEC)));
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                SMALL_RUINS.get(), /* The instance of the structure */
                new StructureFeatureConfiguration(10 /* average distance apart in chunks between spawn attempts */,
                        5 /* minimum distance apart in chunks between spawn attempts. MUST BE LESS THAN ABOVE VALUE*/,
                        243948137 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);
