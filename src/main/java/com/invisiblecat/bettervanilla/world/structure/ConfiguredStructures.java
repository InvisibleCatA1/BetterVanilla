...
public class ConfiguredStructures {
    ...
    public static ConfiguredStructureFeature<?, ?> CONFIGURED_SMALL_RUINS = Structures.SMALL_RUINS.get()
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(BetterVanilla.MODID, "configured_small_ruins"), CONFIGURED_SMALL_RUINS);
    }
}