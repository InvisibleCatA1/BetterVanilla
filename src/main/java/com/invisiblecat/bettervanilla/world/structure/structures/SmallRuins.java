package com.invisiblecat.bettervanilla.world.structure.structures;
...
public class SmallRuins extends StructureFeature<JigsawConfiguration> {
    public SmallRuins(Codec<JigsawConfiguration> codec) {
        // Create the pieces layout of the structure and give it to the game
        super(codec, SmallRuins::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static void setupStructureSpawns(final StructureSpawnListGatherEvent event) {
        if(event.getStructure() == Structures.SMALL_RUINS.get()) {
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!SmallRuins.isFeatureChunk(context)) {
        ...
        JigsawConfiguration newConfig = new JigsawConfiguration(
                ...
                () -> context.registryAccess().ownedRegistryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                        .get(new ResourceLocation(BetterVanilla.MODID, "small_ruins/start_pool")),
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            BetterVanilla.LOGGER.log(Level.INFO, "Rundown House at " + blockpos);
        }
